...
export function AnimatedCharacter({ focusedField, showPassword }: AnimatedCharacterProps) {
  return (
    <motion.div 
      ...
      animate={{
        y: [0, -4, 0],
        rotate: focusedField === 'email' || focusedField === 'name' ? [0, -3, 3, -3, 3, 0] : 0,
      }}
      transition={{
    ...
    >
      <svg width="128" height="144" viewBox="0 0 128 144" fill="none">
        ...
        <motion.path
          ...
          animate={{ 
            scale: 1,
            rotate: (focusedField === 'email' || focusedField === 'name') ? [0, -5, 5, 0] : 0,
          }}
          transition={{ 
            scale: { delay: 0.2, type: "spring" },
            rotate: { duration: 0.5, repeat: (focusedField === 'email' || focusedField === 'name') ? Infinity : 0, repeatDelay: 1.5 }
          }}
        ...
        <motion.ellipse
          ...
          initial={{ rotate: 0 }}
          animate={{
            rotate: (focusedField === 'email' || focusedField === 'name') ? [0, -15, 15, 0] : 0,
          }}
          transition={{
            duration: 1.5,
            repeat: (focusedField === 'email' || focusedField === 'name') ? Infinity : 0,
            ease: "easeInOut"
          }}
